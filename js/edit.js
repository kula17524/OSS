      ...
      try {
        ...
        if (docSnap.exists) {
          ...
          if (data.userId === userId) {
            ...
            const sec_i = document.getElementsByClassName("time_second")[0];
            ...
            if (data.sec_ideal == undefined || data.sec_ideal == null) {
              sec_i.value = "0";
              pre_sec = "0";
            } else {
              sec_i.value = data.sec_ideal;
              pre_sec = data.sec_ideal;
            }
